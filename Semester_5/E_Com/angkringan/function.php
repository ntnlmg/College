...

{
    ...
    $kode_pesanan = substr(uniqid('', true), 0, 12);
    ...
    foreach ($list_pesanan as $lp) {
        ...
        mysqli_query($koneksi, "INSERT INTO `pesanan` (`id_pesanan`, `kode_pesanan`, `kode_menu`, `qty`) 
                                VALUES (NULL, '$kode_pesanan', '$kode_menu', '$qty')
        ");
    }
    ...
    mysqli_query($koneksi, "INSERT INTO `transaksi` (`id_transaksi`, `kode_pesanan`, `nama_pelanggan`, `waktu`)
                            VALUES (NULL, '$kode_pesanan', '$pelanggan', NOW())
    ");
    return mysqli_affected_rows($koneksi);
}
