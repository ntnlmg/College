...
var formContainerLogin = document.getElementById('login-form');
var formContainerSignup = document.getElementById('signup-form');

// Fungsi untuk mengubah tema
function changeTheme(theme) {
  if (theme === 'light') {
    formContainerLogin.style.setProperty('--cust-bg-color', 'white'), formContainerSignup.style.setProperty('--cust-bg-color', 'white');
  } else if (theme === 'dark') {
    formContainerLogin.style.setProperty('--cust-bg-color', 'black'), formContainerSignup.style.setProperty('--cust-bg-color', 'black');;
  }
